...
public class Appointment_continuously_hosa_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_appointment_continuously_hosa_1);
        backchoose = findViewById(R.id.backchoose);
        backchoose.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Appointment_continuously_hosa_1.this,Appointment_continue.class);
                startActivity(i);
                finish();
            }
        });
        ...
        Dateappointment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(Appointment_continuously_hosa_1.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        Timeappointment.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TimePickerDialog TimePicker = new TimePickerDialog(Appointment_continuously_hosa_1.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
